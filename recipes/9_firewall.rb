...
# CIS: 9.1.1, 9.1.2, 9.1.3, 9.1.4, 9.1.5, 9.1.6
registry_key 'HKLM\\Software\\Policies\\Microsoft\\WindowsFirewall\\DomainProfile' do
  values [{
    name: 'EnableFirewall',
    type: :dword,
    data: 1,
...
# CIS: 9.1.7, 9.1.8, 9.1.9, 9.1.10
registry_key 'HKLM\\Software\\Policies\\Microsoft\\WindowsFirewall\\DomainProfile\\Logging' do
  values [{
    name: 'LogFilePath',
    type: :dword,
...
# CIS: 9.2.1, 9.2.2, 9.2.3, 9.2.4, 9.2.5, 9.2.6, 9.2.7, 9.2.8, 9.2.9, 9.2.10
registry_key 'HKLM\\Software\\Policies\\Microsoft\\WindowsFirewall\\PrivateProfile' do
  values [
    {
      name: 'EnableFirewall',
      type: :dword,
...
# CIS: 9.3.1, 9.3.2, 9.3.3, 9.3.4, 9.3.5, 9.3.6, 9.3.7, 9.3.8, 9.3.9, 9.3.10
registry_key 'HKLM\\Software\\Policies\\Microsoft\\WindowsFirewall\\PublicProfile' do
  values [
    {
      name: 'EnableFirewall',
      type: :dword,
